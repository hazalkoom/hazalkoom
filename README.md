...
const mohamed = {
    ...
    askMeAbout: ["Web Dev", "Python", "Django", "Angular"],
    technologies: {
        frontEnd: ["Angular", "HTML5", "CSS3", "Bootstrap"],
        backEnd: ["Django", "Node.js", "Express.js"],
        databases: ["MySQL", "NoSQL", "SQL"],
        languages: ["Python", "JavaScript", "TypeScript", "C#"]
    },
    currentlyLearning: ["Microservices", "Data Analysis"],
...
[![Repo Card](https://github-readme-stats.vercel.app/api/pin/?username=hazalkoom&repo=REPO_NAME_1&theme=radical&hide_border=true&bg_color=0D1117&title_color=667EEA&icon_color=667EEA)](https://github.com/hazalkoom/REPO_NAME_1)
...
> 💡 **Note:** Replace `REPO_NAME_1` and `REPO_NAME_2` with your actual repository names to showcase specific projects!
...
class CurrentGoals:
    def __init__(self):
        self.learning = [
            ...
            "🔹 Angular deep dive & best practices",
            "🔹 Microservices architecture",
            "🔹 Data analysis with Pandas"
        ]
        self.building = "Full-stack web applications"
        self.reading = "Clean Code & Design Patterns"
